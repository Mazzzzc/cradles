...
function setup() {
	...
	bobObject1 = new Bob(173,500,100);
	bobObject2 = new Bob(273,500,100);
	bobObject3 = new Bob(373,500,100);
	bobObject4 = new Bob(473,500,100);
	bobObject5 = new Bob(573,500,100);
